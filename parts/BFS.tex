...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[scale=1.30]<1-1>{bfs000.pdf}
    \end{center}
...
\begin{frame}
    ...
    \framesubtitle{Beispiel}
    \begin{center}
        \includegraphics[scale=1.30]<1-1>{bfs001.pdf}
    \end{center}
...
\begin{frame}
    ...
    \framesubtitle{Beispiel}
    \begin{center}
        \includegraphics[scale=1.30]<1-1>{bfs002.pdf}
    \end{center}
...
\begin{frame}
    ...
    \framesubtitle{Beispiel}
    \begin{center}
        \includegraphics[scale=1.30]<1-1>{bfs003.pdf}
    \end{center}
...
\begin{frame}
    ...
    \framesubtitle{Beispiel}
    \begin{center}
        \includegraphics[scale=1.30]<1-1>{bfs004.pdf}
    \end{center}
...
%     \framesubtitle{Beispiel}
%     \begin{center}
%         \includegraphics[scale=1.30]<1-1>{bfs05.png}
%     \end{center}
%
...
%     \framesubtitle{Beispiel}
%     \begin{center}
%         \includegraphics[scale=1.30]<1-1>{bfs06.png}
%     \end{center}
%
...
%     \framesubtitle{Beispiel}
%     \begin{center}
%         \includegraphics[scale=1.30]<1-1>{bfs07.png}
%     \end{center}
%
...
\begin{frame}
    ...
    \framesubtitle{Beispiel}
    \begin{center}
        \includegraphics[scale=1.30]<1-1>{bfs005.pdf}
    \end{center}
...
\begin{frame}
    ...
    \framesubtitle{Beispiel}
    \begin{center}
        \includegraphics[scale=1.30]<1-1>{bfs006.pdf}
    \end{center}
...
\begin{frame}
    ...
    \framesubtitle{Beispiel}
    \begin{center}
        \includegraphics[scale=1.30]<1-1>{bfs007.pdf}
    \end{center}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item statt zu markieren, speichere das "Level" von \textbf{u} und erhalte die "Kantenentfernung" zu \textbf{s} \\\(\iff\) Länge des kürzesten ungewichteten Pfads \\ \color{gray}{(Anzahl der Hops von \textbf{s} nach \textbf{u})}
    \end{itemize}
\end{frame}
\begin{frame}
    \frametitle{Breitensuche}
